	...
	F.Editing = F.Component.extend(/** @lends FooTable.Editing */{
		...
		construct: function(table){
			...
			this.callbacks = {
				...
				viewRow: F.checkFnValue(this, table.o.editing.viewRow),//AGREGADO POR GENRY
		...
		preinit: function(data){
			...
			this.ft.raise('preinit.ft.editing', [data]).then(function(){
				...
				self.viewText = F.is.string(data.editingViewText) ? data.editingViewText : self.viewText; //AGRAGEDA POR GENRY
				...
				self.callbacks.viewRow = F.checkFnValue(self, data.editingViewRow, self.callbacks.viewRow); // AGREGADO POR GENRY
		...
		/**
		 * Creates the edit button for the view component.
		 * @instance
		 * @protected
		 * @returns {(string|HTMLElement|jQuery)}
		 * AGREGADA POR GENRY
		 */
		$buttonView: function(){
			return '<button type="button" class="btn btn-default footable-view" title="Ver">' + this.viewText + '</button> ';
		},
		/**
		 ...
		 */
		$buttonEdit: function(){
			return '<button type="button" class="btn btn-default footable-edit" title="Editar">' + this.editText + '</button> ';
		},
		/**
		...
		$buttonDelete: function(){
			return '<button type="button" class="btn btn-default footable-delete" title="Eliminar">' + this.deleteText + '</button>';
		},
		/**
		...
		$rowButtons: function(){
			return $('<div class="btn-group btn-group-xs" role="group"></div>')
				.append(this.$buttonView()) //AGREGADA POR GENRY
...
(function($, F) {
	...
	F.Defaults.prototype.editing = {
		...
		alwaysShow: false,
		addRow: function(){},
		viewRow: function(row){}, //AGREGADO POR GENRY
		editRow: function(row){},
		deleteRow: function(row){},
		showText: '<span class="fooicon fooicon-pencil" aria-hidden="true"></span> Editar Datos',
		hideText: 'Cancel',
		//addText: 'New row',
		addText: '<span class="fooicon fooicon-file" aria-hidden="true"></span> Nuevo',
		viewText: '<span class="fooicon fooicon-eye-open" aria-hidden="true"></span>',
